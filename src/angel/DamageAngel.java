...
public class DamageAngel extends Angel {
    ...
    public void interactWith(final Knight knight) {
        ...
        knight.setHelperMultiplyer(DamageAngelConstants.DAMAGE_ANGEL_ON_KNIGHT);
    ...
    public void interactWith(final Pyromancer pyromancer) {
        ...
        pyromancer.setHelperMultiplyer(DamageAngelConstants.DAMAGE_ANGEL_ON_PYROMANCER);
    ...
    public void interactWith(final Wizard wizard) {
        ...
        wizard.setHelperMultiplyer(DamageAngelConstants.DAMAGE_ANGEL_ON_WIZARD);
    ...
    public void interactWith(final Rogue rogue) {
        ...
        rogue.setHelperMultiplyer(DamageAngelConstants.DAMAGE_ANGEL_ON_ROGUE);
